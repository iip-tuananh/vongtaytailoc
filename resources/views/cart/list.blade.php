...
@endsection
@section('css')
<link href="{{asset('frontend/css/bean-carts.scss.css')}}" rel="stylesheet" type="text/css" />
@endsection
@section('js')
@endsection
@section('content')
...
@if (count($cart) > 0)
<section class="wrap_page page_cart">
   <div class="container">
      <div class="row">
         <div class="col-lg-12">
...
<section class="wrap_page page_cart">
   <div class="container">
      <div class="row">
         <div class="col-lg-12">
            <h1 class="title_head left after">
               <span class="padding__">Chưa có sản phẩm nào trong giỏ hàng của bạn.</span>
            </h1>
            <div class="header-cart title_cart_pc hidden-sm hidden-xs">
            </div>
         </div>
