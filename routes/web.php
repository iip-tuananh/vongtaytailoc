...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('vong-theo-menh/{slug}.html','ProductBrandController@listProductBrand')->name('listProductBrand');
    Route::get('tat-ca-vong-theo-menh.html','ProductBrandController@allProductBrand')->name('allProductBrand');
